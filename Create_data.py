...
output_dir = '/media/rrtammyfs/Projects/2018/MRIGAN/data/DCE_MRI'
base_dir = '/media/rrtammyfs/Projects/2018/MRIGAN/data/DCE_MRI/base'
shuffle_out = '/media/rrtammyfs/Projects/2018/MRIGAN/data/DCE_MRI/'
curr_dir = ''
...
data_creator = DataCreatorMulti(data_source, output_dir,data_base='DCE-MRI',axial_limits=np.arange(3,21))
