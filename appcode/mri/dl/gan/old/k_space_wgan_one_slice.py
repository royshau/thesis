...
class KspaceWgan(BasicModel):
    ...
    def __init__(self, input=None, dims_in=None, dims_out=None, FLAGS=None, train_phase=None, adv_loss_w=None):
        """
        :param input:
        :param labels:
        :param dims_in:
    ...
    def __G__(self):
        ...
        # Create the inputs
        x_real = self.input_d['real'] * self.input['mask']
        x_imag = self.input_d['imag'] * self.input['mask']
        ...
        input_masked_real = tf.multiply(self.input_d['real'], self.labels['mask'], name='input_masked_real')
        input_masked_imag = tf.multiply(self.input_d['imag'], self.labels['mask'], name='input_masked_imag')
