...
class KspaceWgan(BasicModel):
    ...
    def __G__(self):
        ...
        if self.FLAGS.dump_debug:
            image_with_zero_padding = self.get_reconstructed_image(real=self.input['real'][:,1,:,:] * self.input['mask_2'],
            ...
            tf.summary.image('image_zero_padding', tf.transpose(image_with_zero_padding, (0, 2, 3, 1)), collections='G', max_outputs=4)
