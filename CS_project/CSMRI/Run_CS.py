...
NII_SUFFIX = '.nii.gz'
DATA_DIR = 'data/'
masks_names = ['mask50_1']#'mask50r_1']#'mask_4_1']#'mask_4_1'] #]#, 'mask_4_1']  #,'mask66','mask_33_row','mask_50_row','mask_66_row']
...
for case in sub_dirs:
    for mask_name in masks_names:
        t =Thread(target=CS_thread,args=(case,mask_name))
        t.start()
t.join()