...
NII_SUFFIX = '.nii.gz'
DATA_DIR = 'data/'
masks_names = ['mask50_1','mask50r_1','mask_4_1']#'mask10','mask33','mask50','mask66','mask_33_row','mask_50_row','mask_66_row']
...
for mask_name in masks_names:
    ...
    for case_num,case in enumerate(sub_dirs,start =0):
        ...
        for i in range(data_org.shape[2]):
    ...
    print('Mask: {2} \n Mean CS PSNR : {0} , STD : {1} \n'.format(PSNR_CS_mean, PSNR_CS_std,mask_name))# Mean ZF PSNR: {2} , STD : {3}'.format(PSNR_CS_mean, PSNR_CS_std,PSNR_ZF_mean,PSNR_ZF_std,mask_name))
